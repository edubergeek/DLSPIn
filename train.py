...
def UNet():
  ...
  conv1 = Conv3D(32, (WDim, 11, 11), activation='relu', padding='same')(inputs)
  conv1 = Conv3D(32, (WDim, 11, 11), activation='relu', padding='same')(conv1)
  conv1 = Conv3D(32, (WDim, 11, 11), activation='relu', padding='same')(conv1)
  conv1 = MaxPooling3D(pool_size=(WDim, 1, 1))(conv1)
  conv1 = Reshape((YDim, XDim, 32))(conv1)
  conv1 = Conv2D(32, (11, 11), activation='relu', padding='same')(conv1)
  conv1 = Conv2D(32, (11, 11), activation='relu', padding='same')(conv1)
  pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)

  conv2 = Conv2D(32, (9, 9), activation='relu', padding='same')(pool1)
  conv2 = Conv2D(32, (9, 9), activation='relu', padding='same')(conv2)
  ...
  conv4 = Conv2D(64, (5, 5), activation='relu', padding='same')(pool3)
  conv4 = Conv2D(64, (5, 5), activation='relu', padding='same')(conv4)
  ...
  conv11 = Conv2D(32, (9, 9), activation='relu', padding='same')(up11)
  conv11 = Conv2D(32, (9, 9), activation='relu', padding='same')(conv11)
